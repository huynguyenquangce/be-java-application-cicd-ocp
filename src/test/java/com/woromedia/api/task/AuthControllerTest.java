...
public class AuthControllerTest {
    ...
    public void testAuthenticateUserSuccess() {
        ...
        // Optionally, you can verify that the authenticationManager's authenticate()
        // method was called with the correct argument
        verify(authenticationManager).authenticate(any(UsernamePasswordAuthenticationToken.class));

        // Optionally, you can verify that the tokenProvider's generateToken() method
    ...
    public void testRegisterUserSuccess() {
        ...
        // Mock userRepository.existsByUsername() to return false (username is not
        // taken)
        ...
        // Optionally, you can verify that userRepository.save() was called with the
        // correct User object
